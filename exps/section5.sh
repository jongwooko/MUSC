...
CUDA_VISIBLE_DEVICES=1 python finetuning_baseline.py --dataset_name mldoc \
...
CUDA_VISIBLE_DEVICES=2 python finetuning_baseline.py --dataset_name mldoc \
...
CUDA_VISIBLE_DEVICES=1 python finetuning_baseline.py --dataset_name cls \
                              --domain books \
                              --experiment books_or_baseline \
                              --trn_languages english,german,french,japanese \
